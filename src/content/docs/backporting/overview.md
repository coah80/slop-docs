...
|--------|---------|-----------|
| `fix:` / `Fix:` | bug fix, usually part of a feature's fix chain | most common (~120) |
| `Merge` | branch merge (many auto-generated by `sync.yml`) | ~59 |
| `chore:` | releases, version bumps, housekeeping | ~43 |
| `feat:` | new content, no TU tag | ~34 |
